...
public:
	...
	int runUtility(OthelloBoard *board);
	std::vector<OthelloBoard*> getSucc(char playerSymbol, OthelloBoard *board);
  	int evalMax(int &row, int &column, char playerSymbol, OthelloBoard *board);
  	int evalMin(int &row, int &column, char playerSymbol, OthelloBoard *board);
